...
//                push.appendMessage("Cookies可能失效了,请仔细检查配置中的Cookies是否有效");
                return false;
            }
            log.pushln("用户名称:%s 硬币余额:%s",HelpUtil.userNameEncode(userInfo.getUname()),String.valueOf(userInfo.getMoney()));
        }
        return true;
    }
